...
entrenador1_pokemon1 = Pokemon_planta(1, "bulbasaur", 50, 8, 10)
entrenador1_pokemon2= Pokemon_agua(4, "squirtle", 45, 9, 11)
entrenador2_pokemon1= Pokemon_fuego(7, "charmander", 47, 11, 7)
entrenador2_pokemon2= Pokemon_electrico(25, "pikachu", 43, 12, 8)
